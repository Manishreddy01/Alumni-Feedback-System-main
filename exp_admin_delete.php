...
<div style='margin-left:25%;padding:1px 16px;height:1000px;'>
  ...
  while($row=$result->fetch_assoc()){
			...
			echo"&nbsp &nbsp &nbsp &nbsp ".$row["data"]."<br><br><br>";
			echo"<form method='post' action='http://localhost/alumni/exp_admin_delete_php.php'>
                <input type='hidden' value=".$row["exp_id"]." name='expid'>";			
