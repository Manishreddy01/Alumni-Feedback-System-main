...
include('exp_admin_upload_php.php');
...
<ul>
  ...
  <button class="dropbtn" style="background-color: #4CAF50;color:white;padding:8px 10px 8px 10px;" >Experiences</button>
  <div class="dropdown-content">
    <a href="exp_admin_upload.php" style="background-color: #4CAF50;color:white;">Upload</a>
...
<div style="margin-left:25%;padding:1px 16px;height:1000px;">
  <h1>Hey !!</h1>
  <h2>Write the Alumni Experience here</h2><br>
  ...
  TITLE :&nbsp &nbsp &nbsp <input type="text" name="title" placeholder="Title" style="width:50%;"><span style="color:red;"> &nbsp &nbsp * <?php echo $er2 ?></span><br><br>
  
   DESCRIPTION :<br><br> <textarea cols="40" rows="8" name="expdata" placeholder="Please enter your text here" style="margin-left:11%;"></textarea><span style="color:red;">&nbsp &nbsp *<?php echo $er4 ?></span><br><br>
