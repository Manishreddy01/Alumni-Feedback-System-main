...
include('news_admin_change_php.php');
...
<ul>
  ...
  <div class='dropdown' style='margin-left:17px;'>
  <button class='dropbtn' style='background-color: #4CAF50;color:white;width:105px;padding:8px 10px 8px 10px;'>News</button>
  <div class='dropdown-content'>
    <a href='news_admin_upload.php'>Upload</a>
    <a href='news_admin_delete.php'>Delete</a>
    <a href='news_admin_change.php' style='background-color: #4CAF50;color:white;'>Change</a>
  </div>
</div>&nbsp &nbsp 
  <div class='dropdown'>
...
<div style='margin-left:25%;padding:1px 16px;height:100%;'>
  ...
  echo"TITLE :&nbsp &nbsp  <input type='text' name='title' style='width:50%;' value=".$row["title"]."><span style='color:red;'> &nbsp &nbsp *".$er2."</span><br><br>";
  echo"TYPE :&nbsp &nbsp  <input type='text' name='type' style='width:50%;' value=".$row["type"]."><br><br>";

   echo"DESCRIPTION :<br><br> <textarea cols='40' rows='8' name='newsdata' style='margin-left:11%;'>".$row["data_news"]."</textarea><span style='color:red;'>&nbsp &nbsp *".$er4."</span><br><br>";
   echo"<input type='hidden' name='newsid' value=".$row["news_id"]." >";
