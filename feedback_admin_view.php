...
<ul>
  ...
  <div class='dropdown'>
  <button class='dropbtn' style='background-color: #4CAF50;color:white;width:90px;padding:8px 10px 8px 10px;border:none;font-family:serif;font-size:19px;'>Feedback</button>
  <div class='dropdown-content'>
    <a href='feedback_admin_view.php' style='background-color: #4CAF50;color:white;'>View</a>
  </div>
</div><br><br><br><br>
</ul>
...
<div style='margin-left:25%;padding:1px 16px;height:100%;'>
  <h1>Hey !!</h1>
  <h2>Update your news here</h2><br>";
  while($row=$result->fetch_assoc()){
			echo"<div class='exbox' style='border:2px ridge #004080;width:50%;margin-left:20%;padding:15px 0px 15px 15px;'>";
echo"Alumni ID : &nbsp".$row["al_id"]."<br><br>";
echo"Batch : &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp".$row["batch"]."<br><br>";
echo"Teaching : &nbsp &nbsp &nbsp &nbsp &nbsp".$row["teach"]."<br><br>";
echo"Infrastructure : ".$row["infrastructure"]."<br><br>";
echo"Lab :&nbsp &nbsp".$row["lab"]."<br><br>";
echo"Curriculum :  &nbsp &nbsp".$row["curriculum"]."<br><br>";
echo" Food canteen : &nbsp &nbsp".$row["food"]."<br><br>";
echo" Surrouondings: &nbsp &nbsp &nbsp".$row["surrounding"]."<br><br>";
echo" Feedback: &nbsp &nbsp &nbsp".$row["food"]."<br><br>";
