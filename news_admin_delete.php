...
<ul>
  ...
  <div class='dropdown'>
  <button class='dropbtn' style='padding:8px 10px 8px 10px;';>Internship</button>
  <div class='dropdown-content'>
  ...
  <div class='dropdown' style='margin-left:17px;'>
  <button class='dropbtn' style='width:105px;padding:8px 10px 8px 10px;background-color: #4CAF50;color:white;'>News</button>
  <div class='dropdown-content'>
    <a href='news_admin_upload.php'>Upload</a>
    <a href='news_admin_delete.php' style='background-color: #4CAF50;color:white;;'>Delete</a>
...
<div style='margin-left:25%;padding:1px 16px;height:1000px;'>
  <h1>Hey !!</h1>
  <h2>Delete the news updates here</h2><br>";
  while($row=$result->fetch_assoc()){
			...
			echo"&nbsp &nbsp &nbsp &nbsp ".$row["data_news"]."<br><br>";
			
			echo"<form method='post' action='http://localhost/alumni/news_admin_delete_php.php'>
                <input type='hidden' value=".$row["news_id"]." name='newsid'>";			
			echo"<input type='submit' style='margin-left:80%;padding:7px;font-size:15px;' class='button_des' value='Delete'></form>";
			echo"</div><br><br>";
		}
