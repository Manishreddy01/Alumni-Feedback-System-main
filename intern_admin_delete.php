...
<ul>
  ...
  <div class='dropdown'>
  <button class='dropbtn' style='background-color: #4CAF50;color:white;padding:8px 10px 8px 10px;';>Internship</button>
  <div class='dropdown-content'>
    <a href='intern_admin_upload.php'>Upload</a>
    <a href='intern_admin_delete.php' style='background-color: #4CAF50;color:white;'>Delete</a>
...
<div style='margin-left:25%;padding:1px 16px;height:1000px;'>
  <h1>Hey !!</h1>
  <h2>Delete the internship uploads here</h2><br>";
  while($row=$result->fetch_assoc()){
			echo"<div class='exbox' style='border:2px ridge #004080;width:50%;margin-left:20%;padding:15px 0px 15px 15px;'>";
			echo"Alumni id: ".$row["Alumni_id"]."<br><br>";
			echo"Company: ".$row["Company"]."<br><br>";
			echo"Position: ".$row["Position"]."<br><br>";
			
			echo"&nbsp &nbsp &nbsp &nbsp ".$row["data"]."<br><br>";
			echo"Contact: ".$row["Contact"]."<br><br><br>";
			echo"<form method='post' action='http://localhost/alumni/intern_admin_delete_php.php'>
                <input type='hidden' value=".$row["id"]." name='internid'>";			
