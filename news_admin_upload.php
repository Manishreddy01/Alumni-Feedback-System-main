...
include('news_admin_upload_php.php');
...
<ul>
  ...
  <div class="dropdown" style="margin-left:17px;">
  <button class="dropbtn" style="background-color: #4CAF50;color:white;width:112px;padding:8px 10px 8px 10px;">News</button>
  <div class="dropdown-content">
    <a href="news_admin_upload.php" style="background-color: #4CAF50;color:white;padding:8px 10px 8px 10px;">Upload</a>
...
<div style="margin-left:25%;padding:1px 16px;height:1000px;">
  <h1>Hey !!</h1>
  <h2>Upload the latest News Updates here</h2><br>
  <form method="post" action="">
  TITLE :&nbsp &nbsp &nbsp <input type="text" name="title" placeholder="Title" style="width:50%;"><span style="color:red;">  * <?php echo $er2 ?></span><br><br>
    TYPE<input type="text" name="type" placeholder="Type/kind" style="width:500px;margin-left:65px;" ><br><br>

   DATA :<br><br> <textarea cols="40" rows="8" name="data" placeholder="Please enter your text here" style="margin-left:11%;"></textarea> &nbsp <span style="color:red;">&nbsp &nbsp *<?php echo $er4 ?></span><br><br>
