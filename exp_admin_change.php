...
include('exp_admin_change_php.php');
...
<ul>
  ...
  <div class='dropdown-content'>
    ...
    <a href='exp_admin_change.php' style='background-color: #4CAF50;color:white;'>Change</a>
  </div>
</div>
  <div class='dropdown'>
...
<div style='margin-left:25%;padding:1px 16px;height:100%;'>
  <h1>Hey !!</h1>
  <h2>Update the experiences here</h2><br>";
  ...
  echo"TITLE :&nbsp &nbsp  <input type='text' name='title' style='width:50%;' value=".$row["title"]."><span style='color:red;'> &nbsp &nbsp *".$er2."</span><br><br>";
   ...
   echo"DESCRIPTION :<br><br> <textarea cols='40' rows='8' name='expdata' style='margin-left:11%;'>".$row["data"]."</textarea><span style='color:red;'>&nbsp &nbsp *".$er3."</span><br><br>";
   echo"<input type='hidden' value=".$row["exp_id"]." name='expid'>";
